...
| Name                                                                                    | Description                                                                                                    | Categorie     | Language |
|-----------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|---------------|----------|
|[StellarTrace](https://github.com/OUIsolutions/StellarTrace)                             |A lua Lib to generate observability                                                                             |Lib            |Lua       |
|[OuiPacker](https://github.com/OUIsolutions/OuiPacker)                                   |a Lua Runtime with all dependencies required to build OUI products                                              |Runtime        |Lua       |
|[C-Cli-Entry](https://github.com/OUIsolutions/C-Cli-Entry)                               | An lib to parse Argv and Argv in C                                                                             |Lib            |C/C++     |
|[Symbiotic-Lua](https://github.com/OUIsolutions/Symbiotic-Lua)                           |a template for hybrid programming between lua and C                                                             |Template       |Lua/C     |
|[TomatoTestter](https://github.com/OUIsolutions/TomatoTestter)                           |An Repo to test Divs position                                                                                   |Lib            |javascript|
|[Tag23](https://github.com/OUIsolutions/Tag23)                                           |Tag23 it's a library for coding inside html, it allows defining conditions, loops and easy evaluations of values|Lib            |javascript|
|[cxpathjson](https://github.com/OUIsolutions/cxpathjson)                                 |An Pure C lib to manipulate json in an mono dimension way                                                       |Lib            |C/C++     |
|[AbsolutePosition](https://github.com/OUIsolutions/AbsolutePosition)                     |A repo to position elements                                                                                     |Lib            |javascript|
|[Element-404](https://github.com/OUIsolutions/Element-404)                               |An extremaly simple js library to create Reactive Ui                                                            |Lib            |javascript|
|[Replacer](https://github.com/OUIsolutions/Replacer)                                     |An Cli Tool to find and replace tokens  in files                                                                |Cli Tool       |C/C++     |
|[COTP_generator](https://github.com/OUIsolutions/COTP_generator)                         |An Lib to create Otp generations in C                                                                           |Lib            |C/C++     |
|[CTolkitBuild](https://github.com/OUIsolutions/CTolkitBuild)                             |An Python Package to manipulate C buildings                                                                     |Lib            |Python    |
